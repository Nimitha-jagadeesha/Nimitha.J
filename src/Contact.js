export default function Contact() {
    return (
        <div className="Contact">
            ...
            <br />
            <div className="row">
                <a href="mailto:nimithajemail@gmail.com" className="col-1 offset-2">
                    <img src={process.env.PUBLIC_URL + "gmail.png"} height={50} width={50} />
                </a>
                <a href="https://github.com/Nimitha-jagadeesha" className="col-1 offset-1">
                    <img src={process.env.PUBLIC_URL + "github.png"}  height={50} width={50}/>
                </a>
                <a href="https://www.linkedin.com/in/nimitha-jagadeesha/" className="col-1 offset-1">
                    <img src={process.env.PUBLIC_URL + "linkedin.png"} height={50} width={50} />
                </a>
                <a href="https://twitter.com/Nimitha__J" className="col-1 offset-1">
